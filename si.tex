...
{\color{red} Janus, why did you change $10^{-3}$ to $\num{1.e-3}$?  I think it is unnecessary to have the extra 1.0. especially since there is $\times \epsilon_1$ following it.}
...
{\color{red} Janus, if you do not like "post blind test" you can replace it with "non-blind", but not "non-blinded".}
